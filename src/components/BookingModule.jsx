            ...
            <div className='relative w-[500px] h-auto border p-6 bg-white rounded'>
                <div className="my-4">
                    <div className='flex flex-col gap-2'>
                        <h1 className='text-black text-lg font-medium'>Buyurtma berish</h1>
                    ...
                    <button onClick={() => setModal(false)} className='bg-transparent text-black border-none absolute top-3 right-3'>
